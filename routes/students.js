...
router.put('/set', student_Act.Set);
router.put('/unset', student_Act.unSet);
router.put('/pop', student_Act.Pop);
router.put('/push', student_Act.Push);
router.put('/pull', student_Act.Pull);
